[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/I68_Ji42)
# Assignment 4
...
5. Execute `ls`. There will now be a new directory called `hunt-the-wumpus-XXX`, where `XXX` is your GitHub username. Enter that directory via `cd`.
