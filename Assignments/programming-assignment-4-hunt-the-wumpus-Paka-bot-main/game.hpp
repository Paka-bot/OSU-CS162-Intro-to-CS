...
private:
	...
	bool wumpus_alive = true; // whether the wumpus is alive or not
...
public:
	 ...
	 * Description: If the arrow fired by the player does not hit the wumpus, 
	 * the wumpus's location is moved randomly on the grid.
	 * Parameters: N/A
	 */
	void move_wumpus_randomly(); // move the wumpus to a random location

	/*
	 * Function: Constructor
	 * Description: Output percepts to the player when the player is near a room with an event.
	 * Parameters: N/A
	 */
	void display_percepts() const; // display percepts around the player
