...
5. Execute `ls`. There will now be a new directory called `programming-assignment-2-wizard-spellbook-catalog-XXX`, where `XXX` is your GitHub username. Enter that directory via `cd`.
